...
def find_env_file() -> Path | None:
    """Find .env or .env.local file in current or parent directories."""
    current = Path.cwd()
...
class Settings(BaseSettings):
    ...
    # === Project ===
    PROJECT_NAME: str = "personal_automations"
    ...
    LOGFIRE_SERVICE_NAME: str = "personal_automations"
    ...
    POSTGRES_DB: str = "personal_automations"
    ...
    # === Registration ===
    REGISTRATION_ENABLED: bool = False  # Set to True to allow public registration
    ...
    S3_ACCESS_KEY: str = ""
    S3_SECRET_KEY: str = ""
    S3_BUCKET: str = "personal_automations"
