      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <Select
              value={storyId || NO_STORY_VALUE}
              onValueChange={(value) => setStoryId(value === NO_STORY_VALUE ? null : value)}
            >
              <SelectTrigger className="w-full">
                <SelectValue placeholder="No story selected" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value={NO_STORY_VALUE}>No story selected</SelectItem>
                {stories.map((story) => (
