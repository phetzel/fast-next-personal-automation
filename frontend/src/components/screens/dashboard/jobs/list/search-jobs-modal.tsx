...
import { Search, Loader2, CheckCircle, XCircle, ExternalLink, RefreshCw } from "lucide-react";
      ...
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={String(formData.hours_old)}
              onValueChange={(value) =>
                setFormData((prev) => ({
                  ...prev,
                  hours_old: parseInt(value, 10),
                }))
              }
              disabled={isRunning}
            >
              <SelectTrigger id="hours-old" className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData((prev) => ({
                  ...prev,
                  scraper: value as "jobspy" | "mock",
                }))
              }
              disabled={isRunning}
            >
              <SelectTrigger id="scraper" className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="jobspy">Real Jobs (LinkedIn, Indeed, etc.)</SelectItem>
