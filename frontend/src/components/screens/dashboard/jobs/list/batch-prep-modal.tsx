...
import { Layers, Loader2, CheckCircle, XCircle, RefreshCw, AlertCircle } from "lucide-react";
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-h-[90vh] max-w-lg overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate cover letters and prep notes for analyzed jobs. Each job will use its
            associated profile, or your default profile when needed.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData((prev) => ({
                  ...prev,
                  tone: value as BatchPrepFormData["tone"],
                }))
              }
              disabled={isRunning}
            >
