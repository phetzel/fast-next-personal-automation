...
import { JobSelectField, ProfileSelectField } from "@/components/shared/jobs";
import type { JSONSchema, JSONSchemaProperty } from "@/types";
import { cn } from "@/lib/utils";

const UNSET_ENUM_VALUE = "__unset_enum__";
    ...
    return (
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent>
            <SelectItem value={UNSET_ENUM_VALUE}>Select...</SelectItem>
